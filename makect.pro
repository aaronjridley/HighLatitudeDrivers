...
pro makect, color
  ...
  if not keyword_set(color) then begin
     ...
     print,'magma   - option a in new color tables'
     print,'inferno   - option b in new color tables'
     print,'plasma   - option c in new color tables'
     print,'viridis   - option d in new color tables'
...
;              b(0:n-1) = ff
              ...
              b(1:n-1) = 1.0 - float(fix(ff*8.0))/9.0
              g(1:n-1) = float(fix(ff*8.0))/9.0
